...
def test1():
    r = knot_hash([0,1,2,3,4], [3,4,1,5])
    assert r == [3,4,2,1,0]


def part1():
    r = knot_hash(list(range(0, 256)), read())
    print(r[0]*r[1])
...
def test2():
    assert ''.join(list(map('{:02x}'.format, [64, 7, 255]))) == '4007ff'
    assert knot_hash2(list(range(0, 256)), '1,2,3') == '3efbe78a8d82f29979031a4aa0b16a9d'
    assert knot_hash2(list(range(0, 256)), '') == 'a2582a3a0e66e6e86e3812dcb672a272'
    assert knot_hash2(list(range(0, 256)), 'AoC 2017') == '33efeb34ea91902bb2f59c9920caa6cd'
    assert knot_hash2(list(range(0, 256)), '1,2,4') == '63960835bcdc130f0b66d7ff4f6a5a8e'
